package com.letskodeit.teachable.ch25.testngannoasserts.regression;

import com.letskodeit.teachable.ch25.testngannoasserts.SomeClassToTest;
import com.letskodeit.teachable.ch25.testngannoasserts.base.BaseTestSuite;
...
public class TestNG_TestClass2 extends BaseTestSuite {
    ...
    @BeforeClass
    public void setUp() {
        System.out.println("-TEST CLASS 2 --- Before class.");
    }

    @AfterClass
    public void tearDown() {
        System.out.println("-TEST CLASS 2 --- After class.");
    }
